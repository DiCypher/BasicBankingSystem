...
session_start();
$stmt = $pdo->query("SELECT id, name, email, balance FROM customers");
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav fs-4">
                  ...
                  <a class="nav-link active" aria-current="page" href="customers.php"><i class="fas fa-users">Customers</i></a>
        ...
        <section>
            <table class="table table-hover fs-5" id="cust">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                ...
                <tbody>
                  ...
                  echo"<tr>";
                    ...
                    echo'<td><form action="transfer.php" method="post">
                    <button type="submit" class="btn btn-outline-success fw-bold" name = "id" value = '.htmlentities($row["id"]).'>Transfer Money</button>
                  </form></td>';
                  echo"</tr>";
                  }
                  ?>
